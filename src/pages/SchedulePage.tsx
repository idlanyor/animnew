    ...
    <div className="mx-auto px-4 py-8">
      ...
      <div className="grid gap-8">
        {scheduleData.map((day) => (
          <div key={day.day} className="bg-gray-900 rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-6">
              {day.anime_list.length > 0 ? (
                  ...
                  {day.anime_list.map((anime) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-gray-200 font-medium group-hover:text-blue-400 transition-colors line-clamp-2">
                          {anime.anime_name}
                        </h3>
                      </div>
                ...
                <p className="text-gray-400 text-center py-4">No anime scheduled for this day</p>
              )}
            </div>
          </div>
        ))}
