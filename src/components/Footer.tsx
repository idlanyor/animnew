      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <div className="mb-4">
              <Link to="/" className="inline-flex items-center space-x-2 text-white hover:text-cyan-400 transition-colors">
                <FontAwesomeIcon icon={faPlay} className="h-8 w-8 text-cyan-400" />
            ...
            <div className="glass-card p-4 rounded-lg border border-white/10 mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="glass-card p-3 rounded-lg border border-white/10 hover:border-cyan-400/30 transition-colors">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 rounded bg-cyan-500/20">
                    <FontAwesomeIcon icon={faArrowTrendUp} className="text-cyan-400 h-4 w-4" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Ongoing</p>
                    <p className="text-white font-bold text-sm">1000+</p>
                  </div>
                </div>
              </div>
              <div className="glass-card p-3 rounded-lg border border-white/10 hover:border-purple-400/30 transition-colors">
                <div className="flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <Link
                  ...
                  className={`${category.color} border border-white/10 px-2.5 py-1 rounded text-xs font-medium text-white transition-colors`}
                >
                  {category.label}
                </Link>
              ))}
